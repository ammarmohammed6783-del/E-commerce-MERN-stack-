...
export default function Prod({ product }: CardProps) {
    ...
    return (
        <section className="grid grid-cols-1 gap-8 rounded-[2rem] border border-stone-200 bg-white md:grid-cols-[0.92fr_1.08fr] md:p-10">
            <div className="flex items-center justify-center gap-5">
                <div className="flex min-h-105 w-full flex-1 items-center justify-center rounded-[2rem] border border-stone-200 bg-[linear-gradient(135deg,#f6f2eb_0%,#e7dfd5_100%)] p-5">
                    <div className="relative flex h-90 w-70 items-center justify-center rounded-[2rem] border-2 border-stone-300 bg-[radial-gradient(circle_at_center,#d6d3d1_0%,#e7e5e4_60%,#f5f5f4_100%)]">
            ...
            <section className="flex flex-col justify-center">
                ...
                <div className="mt-7 rounded-[1.75rem] border border-stone-200 bg-[linear-gradient(135deg,#fffdf9,#f6f4ee)] p-5">
